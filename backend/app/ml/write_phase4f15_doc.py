...
def generate_report():
    ...
    target_paths = [
        os.path.join(base_dir, "docs", "PHASE_4F-15_CONTROLLED_MULTI_REGION_SHADOW_CALIBRATION_PILOT.md"),
        os.path.join(base_dir, "backend", "docs", "PHASE_4F-15_CONTROLLED_MULTI_REGION_SHADOW_CALIBRATION_PILOT.md")
    ]
    ...
    for tp in target_paths:
        ...
        with open(tp, "w", encoding="utf-8") as f:
            f.write(text)
        print(f"Report successfully written to {tp}")
